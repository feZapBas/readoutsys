...
export RDI_DATADIR="/mnt/71b93e02-0f1d-4d32-9e5e-ba2734ee3f54/tool/Vivado/2024.2/data"
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/mnt/71b93e02-0f1d-4d32-9e5e-ba2734ee3f54/tool/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb rtos_sys.wdb xsim.dir libdpi.so)
