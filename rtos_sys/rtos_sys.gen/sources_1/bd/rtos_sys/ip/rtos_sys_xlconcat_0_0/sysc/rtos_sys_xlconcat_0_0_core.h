...
#ifndef _rtos_sys_xlconcat_0_0_core_h_
#define _rtos_sys_xlconcat_0_0_core_h_
...
class rtos_sys_xlconcat_0_0_core : public sc_module 
{
    public: 
       rtos_sys_xlconcat_0_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(rtos_sys_xlconcat_0_0_core);
    ...
    virtual ~rtos_sys_xlconcat_0_0_core() = default;
