...
architecture STRUCTURE of rtos_sys_white_0_0_white is
  ...
  attribute SOFT_HLUTNM of axis_tlast_INST_0 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of axis_tvalid_i_i_1 : label is "soft_lutpair0";
...
axis_tlast_INST_0_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
axis_tlast_INST_0_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
      ...
      I2 => \^axis_tdata\(24),
      I3 => \^axis_tdata\(25),
      I4 => axis_tlast_INST_0_i_6_n_0,
      O => axis_tlast_INST_0_i_2_n_0
    );
axis_tlast_INST_0_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFF7FFF"
    )
        port map (
      ...
      I2 => \^axis_tdata\(0),
      I3 => \^axis_tdata\(1),
      I4 => axis_tlast_INST_0_i_7_n_0,
      O => axis_tlast_INST_0_i_3_n_0
    );
axis_tlast_INST_0_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFEFFF"
    )
        port map (
...
axis_tlast_INST_0_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
axis_tlast_INST_0_i_7: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
axis_tlast_INST_0_i_8: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
axis_tvalid_i_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFE0000"
    )
        port map (
